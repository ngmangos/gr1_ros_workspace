...
: ${AMENT_CURRENT_PREFIX:="/workspace/fourier-sim/ros_ws/install/ros_fourier"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros_fourier/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros_fourier/environment/path.sh"
